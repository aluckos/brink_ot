...
class BrinkOpenTherm : public PollingComponent {
 public:
  ...
  void set_ventilation_number(BrinkNumber *n) { vent_num = n; }
  ...
  void update() override {
    ...
    switch(current_step) {
      ...
      case 4:
        ...
        if (response && t_exhaust_out_temp) t_exhaust_out_temp->publish_state(ot->getFloat(response));
        current_step++; break;
      case 5: // Flow LB
...
static void IRAM_ATTR handleInterrupt() { if (global_brink_ot) global_brink_ot->ot->handleInterrupt(); }
