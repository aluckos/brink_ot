...
def to_code(config):
    ...
    # Pobieranie biblioteki jako ZIP - omija błędy 'git clone' i 'Username for github'
    cg.add_library(None, None, "https://github.com/ihormaze/OpenTherm/archive/refs/heads/master.zip")
